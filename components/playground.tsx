...
export function Playground() {
  const algorithms = SORTING_ALGORITHMS;
  ...
  const regenerate = (p: Preset, n: number) => {
    setPreset(p);
    setSize(n);
  ...
  return (
    <>
      <div className="pg-head">
        <h1 className="pg-title">Sorting</h1>
        <div className="tabs" role="tablist" aria-label="Sorting algorithms">
          {algorithms.map((a) => (
            <button
              key={a.id}
              role="tab"
            ...
            <div className="data-row">
              <label className="field">
                ...
                <select
                  className="select"
                  value={preset}
                  onChange={(e) => regenerate(e.target.value as Preset, size)}
                >
                  {PRESETS.map((p) => (
              ...
              <label className="field">
                ...
                <input
                  ...
                  max={24}
                  value={size}
                  onChange={(e) => regenerate(preset, Number(e.target.value))}
              ...
              <button
                type="button"
                className="ghost-btn"
                onClick={() => regenerate(preset, size)}
              >
                new array
              </button>
              <label className="field">
          ...
          <table className="cx-table">
            <tbody>
              <tr>
                ...
                <td>{alg.complexity.best}</td>
              </tr>
              <tr>
                <th scope="row">average</th>
                <td>{alg.complexity.average}</td>
              </tr>
              <tr>
                <th scope="row">worst</th>
                <td>{alg.complexity.worst}</td>
              </tr>
              <tr>
                <th scope="row">space</th>
                <td>{alg.complexity.space}</td>
              </tr>
              <tr>
                <th scope="row">stable</th>
                <td>{alg.complexity.stable}</td>
              </tr>
            </tbody>
          </table>
        </div>
